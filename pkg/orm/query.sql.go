...
SELECT listen_id, feed_slug, spotify_song_id, spotify_href, spotify_uri, artist, artist_genres, track_name, album_name, album_image, album_image_height, album_image_width, listened_at FROM listen ORDER BY listen_id DESC LIMIT ?
`
...
SELECT listen_id, feed_slug, spotify_song_id, spotify_href, spotify_uri, artist, artist_genres, track_name, album_name, album_image, album_image_height, album_image_width, listened_at FROM listen ORDER BY listen_id DESC LIMIT 1
`
